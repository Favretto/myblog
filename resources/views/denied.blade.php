    ...
    <body class="antialiased">
		...
		<!--
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
					...
					<div style="display: flex; align-items: center; gap: 20px;">
						...
						<div style="display: flex; flex-direction: column; justify-content: center;">
							<h2 style="font-size: 48px; font-weight: bold; color: yellow; margin: 0;">Accesso Negato!</h2>
						</div>
					</div>
                </div>
				
				<h3 style="color: white;">(Modalità ospite non ancora disponibile)</h3>
				<br/>
				...
				<a href="{{ route('login') }}" aria-label="Vai alla home" style="display:inline-flex; align-items:center; text-decoration:none;">
					<!-- Icona login/entrata -->
					<svg fill="none" stroke="yellow" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
						 viewBox="0 0 24 24" width="24" height="24" style="margin-right:6px;">
						<path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4" /> <!-- portale/porta -->
						<path d="M10 17l5-5-5-5" /> <!-- freccia verso destra -->
						<path d="M15 12H3" />        <!-- linea orizzontale -->
					</svg>
					<span style="color:white; font-weight:bold;">Accedi!</span>
				</a>
